...
export default function InstructorQuizzes() {
  ...
  const { data: courses, isLoading, isError } = useQuery({
    ...
    queryFn: async () => (await api.get('/instructor/courses')).data,
  })
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage quizzes for your courses</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Search your courses and edit their quizzes</CardDescription>
        </CardHeader>
        <CardContent>
