      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {course_performance?.slice(0, 5).map((course: any) => (
            ...
            {(!course_performance || course_performance.length === 0) && (
              <p className="text-muted-foreground text-center py-4">
                No courses created yet. <Link to="/instructor/courses/create" className="text-primary hover:underline">Create your first course</Link>
              </p>
            )}
          </CardContent>
        </Card>
